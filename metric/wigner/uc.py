# -*- coding: utf-8 -*-
"""Unicode symbol storage"""
## \namespace geo.metric.wigner.uc Unicode symbols for bras and kets.
"""
...
## Map for VULGAR fractions: frac[numerator][denominator] -> unicode
VULGAR = {1:{2: half, 3:third, 4: u"\u00BD", 5: u"\u2155", 6: u"\u2159",
             7: u"\u2150", 7: u"\u215B", 9: u"\u2151", 10: u"\u2152"},
          2: {3: u"\u2154", 5: u"\u2156"},
          3: {5: u"\u2157", 8: u"\u215C"},
          4: {5: u"\u2158"},
...
## ASCII to unicode symbol table
SYMBOLS = {"/": slash, "<": bra, ">": ket, "(": LEFT_PARENTHESIS,
           ")": RIGHT_PARENTHESIS, "|": bar, "sqrt": sqrt}
